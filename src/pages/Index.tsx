        ...
        <div className="container mx-auto px-6 py-24 text-center">
          <div className="animate-fade-in">
            <div className="flex items-center justify-center mb-6">
              <img 
                src="img/63c4cce9-faff-4510-b06e-21345b604eac.jpg" 
                alt="Антошкабот.рф" 
                className="h-16 w-auto mr-4 rounded-lg"
              />
              <h1 className="font-heading text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                Антошкабот.рф
              </h1>
            </div>
      ...
      <footer className="py-12 bg-gray-900 text-white">
        <div className="container mx-auto px-6 text-center">
          <div className="flex items-center justify-center mb-4">
            ...
            />
            <div className="font-heading text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              Антошкабот.рф
            </div>
          </div>
